...
-- ---- Community members ----------------------------------------------
-- Roles: admin_finca (Carlos), junta (Miguel, Beatriz),
...
from (values
  ('aaaa0001-0000-0000-0000-000000000001'::uuid, '3'::text, 'B'::text, 'junta'::member_role),
  ('aaaa0001-0000-0000-0000-000000000002'::uuid, '1', 'A', 'admin_finca'::member_role),
